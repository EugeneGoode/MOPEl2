...
class Lab2:
    ...
    def matrix23(self):
        ...
        print(
            "Дані варіанту 207 : Y_max = {}  Y_min = {}  X1_min = {}  X1_max = {}  X2_min = {}  X2_max = {}".format(
    ...
    def exp(self):
        ...
        if not self.check_homogeneity():
            ...
            e.msgbox("Дісперсія неоднорідна! :(", "Error")
            self.N += 1
            self.add()
    ...
    def print(self):
        print("Остаточні дані варіанту 207 після перевірок : Y_max = {}  Y_min = {}  X1_min = {}  X1_max = {}  X2_min = {}  X2_max = {}".format(
            self.Y_max, self.Y_min, self.X1_min, self.X1_max, self.X2_min, self.X2_max))
        print("Матриця планування для m = {}".format(self.N))
        print("-" * 13)
        for i in range(3):
